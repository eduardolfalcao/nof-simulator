...
//		long seed = 1;
		...
		String outputDir = "/home/eduardolfalcao/Área de Trabalho/debug-experimentos/";
...
//		double[] fixedDemand = { 3.857142857, 4};
//		double[] variablePIK05 = { 0.1489361702, 0.1428571429};
...
//		double[] fixedPI = { 0.4571428571, 0.5, 0.5428571429,
//				0.5857142857, 0.6285714286, 0.6714285714, 0.7142857143,
//				0.7571428571, 0.8 };
//		double[] variableDK05 = {1.59375, 1.5, 1.421052632,
//				1.353658537, 1.295454545, 1.244680851, 1.2, 1.160377358, 1.125 };
		
		double[] fixedPI = { 0.5};
		double[] variableDK05 = {1.5};
...
//				2.957446809, 2.6, 2.283018868, 2 };
		...
		for (double changingValue : new double[] { 0.05 }) { // 0.05
			...
			for (boolean dynamic : new boolean[] { true }) { // true, false
