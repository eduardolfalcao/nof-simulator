...
public class Main {
	...
	public static void main(String [] args){
		...
		boolean [] pairwiseArray = {true, false};
		
		
		for(boolean pairwise : pairwiseArray){
			
			String outputDir = "/home/eduardolfalcao/Área de Trabalho/Dropbox/Doutorado/Disciplinas/Projeto de Tese 2/SoCC2015/globalVSpairwiseDebug/";
			if(pairwise)
				outputDir += "pairwise/";
			else
				outputDir += "global/";
