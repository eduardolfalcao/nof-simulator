...
//		 * Design 1:
//		 * 
//		 * Collaborators C = {1, 1, 1} D = {1.5, 2, 3} PI = 0.3, 0.4615384615,
//		 * 0.6315789474, 0.7741935484 #Collab = {25, 25, 25}
//		 * 
//		 * Free Riders C = {1, 1, 1} D = {1.5, 2, 3} PI = {9, 8, 8}
//		 */
//
//		int numPeers = 100;
//		int numSteps = 10000;
...
//		double fairnessLowerThreshold = 0.8; // o "normal" é 0.95
//		double changingValue = 0.05;
//		long seed = 1;
//		Level level = Level.SEVERE;
//
//		String outputDir = "/home/eduardolfalcao/Área de Trabalho/Dropbox/Doutorado/Disciplinas/Projeto de Tese 2/SoCC2015/equal-peers/tau80-f75";
//
...
//
//		// int [] numberOfFreeRidersFixedDemandK05 = new int [] {25, 23, 21, 20,
//		// 19, 18, 17, 16, 15, 15, 14, 14, 13, 12, 12};
//		// int [] numberOfCollaboratorsDemandK05 = new int [] {75, 77, 79, 80,
//		// 81, 82, 83, 84, 85, 85, 86, 86, 87, 88, 88};
//
...
//					numberOfCollaborators, numberOfFreeRiders, dynamic,
//					nofWithLog, fairnessLowerThreshold, d, capacitySupplied,
//					changingValue, seed, level, outputDir
//							+ (dynamic ? "fdnof-" : "sdnof-")
//							+ design
//							+ "D"
//							+ (formatter.format(fixedDemand[i])).replace(",",
//									".") + kappa05, pairwise, kappa, design,
//					index);
//			sim.startSimulation();
//
//			kappa = 1;
//			pi[0] = variablePIK1[i];
//			sim = new Simulator(numPeers, numSteps, pi, numberOfCollaborators,
//					numberOfFreeRiders, dynamic, nofWithLog,
//					fairnessLowerThreshold, d, capacitySupplied, changingValue,
//					seed, level, outputDir
//							+ (dynamic ? "fdnof-" : "sdnof-")
//							+ design
//							+ "D"
//							+ (formatter.format(fixedDemand[i])).replace(",",
//									".") + kappa1, pairwise, kappa, design,
//					index);
//			sim.startSimulation();
//
//			kappa = 2;
...
//		int[] numberOfCollaboratorsDemandK05 = new int[] { 84, 81, 78, 76, 73,
//				71, 69, 67, 65, 64, 62, 60, 59, 57, 56 };
//
...
//					numberOfFreeRiders, dynamic,
//					nofWithLog, fairnessLowerThreshold, d, capacitySupplied,
//					changingValue, seed, level, outputDir
//							+ (dynamic ? "fdnof-" : "sdnof-") + design + "PI"
//							+ (formatter.format(fixedPI[i])).replace(",", ".")
...
//					numberOfFreeRiders, dynamic, nofWithLog,
//					fairnessLowerThreshold, d, capacitySupplied, changingValue,
//					seed, level, outputDir + (dynamic ? "fdnof-" : "sdnof-")
//							+ design + "PI"
//							+ (formatter.format(fixedPI[i])).replace(",", ".")
...
//		//
//		// double [] fixedPI = {0.2, 0.2428571429, 0.2857142857, 0.3285714286,
//		// 0.3714285714, 0.4142857143, 0.4571428571,
//		// 0.5, 0.5428571429, 0.5857142857, 0.6285714286, 0.6714285714,
//		// 0.7142857143, 0.7571428571, 0.8};
//		//
//		// int [] numberOfFreeRidersFixedDemandK05 = new int [] {16, 19, 22, 24,
//		// 27, 29, 31, 33, 35, 36, 38, 40, 41, 43, 44};
//		// int [] numberOfCollaboratorsDemandK05 = new int [] {84, 81, 78, 76,
//		// 73, 71, 69, 67, 65, 64, 62, 60, 59, 57, 56};
//		//
//		//
//		// double [] variableDK05 = {3, 2.558823529, 2.25, 2.02173913,
//		// 1.846153846,
...
//		//
//		// double [] variableDK1 = {5, 4.117647059, 3.5, 3.043478261,
//		// 2.692307692,
...
//		//
//		// double [] variableDK4 = {17, 13.47058824, 11, 9.173913043,
//		// 7.769230769,
...
//		// double kappa = 0.5;
//		//
//		// Simulator sim = new Simulator(numPeers, numSteps, pi, new int
//		// []{numberOfCollaboratorsDemandK05[i]}, new int []
//		// {numberOfFreeRidersFixedDemandK05[i]},
//		// dynamic, nofWithLog, fairnessLowerThreshold, d, capacitySupplied,
//		// changingValue, seed, level,
//		// outputDir+(dynamic?"fdnof-":"sdnof-")+design+"PI"+(formatter.format(fixedPI[i])).replace(",",
//		// ".")+kappa05, pairwise,
//		// kappa, design, index);
//		// sim.startSimulation();
//		//
//		// kappa = 1;
//		// d[0] = variableDK1[i];
//		// sim = new Simulator(numPeers, numSteps, pi, new int [] {99}, new int
//		// [] {1},
//		// dynamic, nofWithLog, fairnessLowerThreshold, d, capacitySupplied,
//		// changingValue, seed, level,
//		// outputDir+(dynamic?"fdnof-":"sdnof-")+design+"PI"+(formatter.format(fixedPI[i])).replace(",",
